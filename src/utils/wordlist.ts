...
const loadDefaultWordList = async (): Promise<string[]> => {
  try {
    ...
    return [
      'ocean', 'bicycle', 'elephant', 'coffee', 'mountain',
      'guitar', 'rainbow', 'butterfly', 'chocolate', 'airplane',
      'sunset', 'garden', 'library', 'pizza', 'camera',
      'adventure', 'friendship', 'thunder', 'keyboard', 'lighthouse'
    ];
  }
};
